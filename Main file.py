...
while True:
    ...
    # Detect if the space key is pressed for jumping
        ...
        start_text = font.render("Welcome to the Cowboy Jump! \n Press SPACE to start \n Achieve the highest score by successfully jumping over cacti and avoiding snakes! Points are earned for each cactus successfully jumped over. Avoid snakes to keep from losing points but remember that the game continues as long as you avoid hitting a cactus.", True, (0, 0, 0))
